...
/*
  ...
  Pretty much a copy of Standalone.httpserver but adds index.html as default
  file.
*/
...
int main(int argc, array(string) argv)
{
  ...
  mixed e = catch {
    ...
    Stdio.write_file("server.pid", "" + getpid());
  ...
  werror("Unable to start server. Is one running?\nError: %s\n",
         describe_error(e));
